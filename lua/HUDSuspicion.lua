...
function HUDSuspicion:_set_suspicion_text_visibility(panel)
	panel:child("suspicion_text"):set_visible(Oxalis:GetOption("show_suspicion_text"))
	for i = 1, 4 do
		panel:child("suspicion_bgtext" .. i):set_visible(Oxalis:GetOption("show_suspicion_text") and Oxalis:GetOption("show_text_borders"))
	end
end
