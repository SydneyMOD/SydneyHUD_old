...
function HUDInteraction:show_interaction_bar(current, total)
	...
	self._interact_circle:set_visible(Oxalis:GetOption("show_interaction_circle"))
	self._interact_timer_text:set_visible(Oxalis:GetOption("show_interaction_text"))
	for i = 1, 4 do
		self["_bgtext" .. i]:set_visible(Oxalis:GetOption("show_interaction_text") and Oxalis:GetOption("show_text_borders"))
	end
end
...
function HUDInteraction:set_interaction_bar_width(current, total)
	...
	local color = Color(Oxalis:GetOption("interaction_color_r"), Oxalis:GetOption("interaction_color_g"), Oxalis:GetOption("interaction_color_b"))
...
function HUDInteraction:hide_interaction_bar(complete)
	hide_interaction_bar_original(self, complete and Oxalis:GetOption("show_interaction_circle"))
